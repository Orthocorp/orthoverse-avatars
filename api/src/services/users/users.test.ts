...
describe('users', () => {
  ...
  scenario('updates a user', async (scenario: StandardScenario) => {
    ...
    const result = await updateUser({
      id: original.id,
      input: { address: 'String26590112' },
    })

    expect(result.address).toEqual('String26590112')
  })
